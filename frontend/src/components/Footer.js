...
const Footer = () => {
  return (
    <footer className="bg-slate-900/80 backdrop-blur-sm mt-16 border-t border-white/10" data-testid="footer">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link to="/" className="text-blue-200 hover:text-white text-sm transition-colors" data-testid="footer-home">
                  Home
                </Link>
              </li>
              <li>
                <Link to="/about" className="text-blue-200 hover:text-white text-sm transition-colors" data-testid="footer-about">
                  About Us
                </Link>
              </li>
              <li>
                <Link to="/contact" className="text-blue-200 hover:text-white text-sm transition-colors" data-testid="footer-contact">
                  Contact Us
                </Link>
              </li>
              <li>
                <Link to="/privacy" className="text-blue-200 hover:text-white text-sm transition-colors" data-testid="footer-privacy">
                  Privacy Policy
                </Link>
              </li>
              <li>
                <Link to="/terms" className="text-blue-200 hover:text-white text-sm transition-colors" data-testid="footer-terms">
                  Terms of Service
                </Link>
              </li>
            </ul>
          ...
          {/* Categories */}
          <div>
            <h3 className="text-white font-semibold mb-4">Popular Leagues</h3>
        ...
        {/* Bottom Bar */}
        <div className="border-t border-white/10 pt-6 flex flex-col md:flex-row justify-between items-center text-blue-300/70 text-xs gap-2">
