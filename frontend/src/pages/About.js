    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900">
      ...
      <main className="container mx-auto px-3 sm:px-4 py-4 sm:py-8 max-w-7xl">
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-xl sm:rounded-2xl p-5 sm:p-8 mb-6 sm:mb-8 shadow-2xl" data-testid="about-hero">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm rounded-xl p-5 sm:p-8 mb-6 sm:mb-8 border border-white/10" data-testid="about-content">
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Who We Are</h2>
            <p className="text-blue-200 mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base">
            ...
            <h2 className="text-xl sm:text-2xl font-bold text-white mb-3 sm:mb-4">Important Notice</h2>
            ...
            <ul className="text-blue-200 space-y-1.5 sm:space-y-2 mb-4 sm:mb-6 list-disc list-inside text-sm sm:text-base">
